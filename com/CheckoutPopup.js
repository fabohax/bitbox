    ...
    <div>
      <div className="popup">
        <div className="popup-content">
          ...
          <p>{cartItems.length} product{cartItems.length === 1 ?('') : ('s')} to buy for ${totalPrice}{' '}</p>
          ...
          <form onSubmit={toHome}>
            <input type="text" placeholder="Email or Telegram" value={email} onChange={(e) => setEmail(e.target.value)} />
